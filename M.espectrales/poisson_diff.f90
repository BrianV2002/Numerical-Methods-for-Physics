program poisson
       ...
       real*8, dimension(nx) :: A1, A2, A3 ,work4! Elementos de las diagonales
       real*8, dimension(nx-1) :: work2, work3 
       ...
       call s3p_fa(nx,A1,A2,A3,INFO,work2,work3,work4)
       ...
       print*, 'error respecto a la teórica' , csi
